...
function  deleteMasterSkill() {        
  ...
  if (id === "") {
    ...
    // delete this skill
    deleteCareerStrategyAPI(pathSkills, "",  id, displaySkillsMasterList);                                   
  }
}
...
function  addMasterSkill() {        
  ...
  if (masterSkill && masterSkill.length > 0) {
    ...
    postCareerStrategyAPI(pathSkills, newSkill, props.userId, displaySkillsMasterList);
  }
}
...
*/
  function displaySkillsMasterList(data) { 
    ...
    $('.js-page-content').html(`${headerAndSkills}`);
