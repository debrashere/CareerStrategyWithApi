...
//exports.TEST_DATABASE_URL = process.env.TEST_DATABASE_URL || 'mongodb://<mlab01User>:<Fit4newyear>@ds225624.mlab.com/careerstrategy';
//exports.PORT = process.env.PORT || 25624;
exports.MONGODB_URI = 'mongodb://localhost/career-strategy'
