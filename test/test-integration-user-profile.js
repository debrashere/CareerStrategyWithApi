...
describe('User Profile', function() {
  ...
  before(function() {
   // return runServer();                       
    return   runServer("mongodb://localhost:27017/career-strategy").catch(err => console.error(err));  
    //return   runServer('mongodb://<mlab01User>:<Fit4newyear>@ds225624.mlab.com:25624/careerstrategy')
  ...
  after(function() {
    //return closeServer();
    return   closeServer("mongodb://localhost:27017/career-strategy").catch(err => console.error(err));  
       
    //return closeServer('mongodb://<mlab01User>:<Fit4newyear>@ds225624.mlab.com:25624/careerstrategy')
    //.catch(err => console.error(err));  
  });
